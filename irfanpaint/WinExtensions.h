...
* 30-Jul-09 | Added all the missing macros from COMCTHLP.H
* 03-Ago-08 | Added Toolbar_GetButtonInfo, Toolbar_SetButtonInfo,
*           | Toolbar_GetImageList, Toolbar_SetImageList, 
*           | ToolTip_TrackPosition, ToolTip_TrackActivate
*****************************************************************************/
/* Copyright notice from COMCTHLP.H:
  ---------------------------------------------------
...
#if !defined (_WINEXTENSIONS_H_)
#define _WINEXTENSIONS_H_

#ifdef _WINEXTENSIONS_OVERRIDE_
#pragma warning(push)
...
#define Toolbar_GetButtonInfo(hwnd, idButton, lptbbi) \
	(int)SendMessage((hwnd),TB_GETBUTTONINFO,(WPARAM)(UINT)(idButton),(LPARAM)(LPTBBUTTONINFO)lptbbi)
...
#define Toolbar_GetImageList(hwnd) \
	(HIMAGELIST)SendMessage((hwnd),TB_GETIMAGELIST,(WPARAM)0,(LPARAM)0)
...
#define Toolbar_SetButtonInfo(hwnd, idButton, lptbbi) \
	(BOOL)SendMessage((hwnd),TB_SETBUTTONINFO,(WPARAM)(UINT)(idButton),(LPARAM)(LPTBBUTTONINFO)lptbbi)

#define Toolbar_SetImageList(hwnd, iImageID, hImageList) \
	(BOOL)SendMessage((hwnd),TB_SETIMAGELIST,(WPARAM)(INT)(iImageID),(LPARAM)(HIMAGELIST)(hImageList))
...
#define RichEdit_GetScrollPos(hwnd, lpPos) \
	(UINT)SendMessage((hwnd), EM_GETSCROLLPOS, 0, (LPARAM) (LPPOINT) (lpPos))

#define RichEdit_GetSelText(hwnd, lpBuf) \
    (int)SendMessage((hwnd), EM_GETSELTEXT, 0, (LPARAM) (LPSTR) lpBuf)

#define RichEdit_GetTextEx(hwnd, lpGTE, lpString) \
	(UINT)SendMessage((hwnd), EM_GETTEXTEX, (WPARAM) (GETTEXTEX *) (lpSTE), (LPARAM) (lpString))
...
#define RichEdit_SetScrollPos(hwnd, lpPos) \
	(UINT)SendMessage((hwnd), EM_SETSCROLLPOS, 0, (LPARAM) (LPPOINT) (lpPos))
...
#define RichEdit_SetTextEx(hwnd, lpSTE, lpString) \
	(UINT)SendMessage((hwnd), EM_SETTEXTEX, (WPARAM) (SETTEXTEX *) (lpSTE), (LPARAM) (lpString))
...
#define ToolTip_TrackActivate(hwnd, bActivate, lpti) \
	(void)SendMessage((hwnd), TTM_TRACKACTIVATE, (WPARAM)(BOOL)(bActivate), (LPARAM)(LPTOOLINFO)(lpti))

#define ToolTip_TrackPosition(hwnd, xPos, yPos) \
	(void)SendMessage((hwnd), TTM_TRACKPOSITION, (WPARAM) 0, (LPARAM) MAKELPARAM((xPos), (yPos)))
